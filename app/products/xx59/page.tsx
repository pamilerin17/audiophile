...
import pp from '@/assets/assets/assets/product-xx59-headphones/desktop/image-gallery-1.jpg';
import ppp from '@/assets/assets/assets/product-xx59-headphones/desktop/image-gallery-2.jpg';
import pppp from '@/assets/assets/assets/product-xx59-headphones/desktop/image-gallery-3.jpg';
    ...
    <div className="px-6 md:px-24 py-20">
      ...
      <section className="mt-10 grid md:grid-cols-2 gap-12 items-center">
        <div className="bg-[#F1F1F1] rounded-lg flex items-center justify-center py-12">
          <Image src={Picttt} alt="XX59 headphones" className="w-[250px] md:w-[400px]" />
        </div>
      ...
      <section className="mt-28 grid md:grid-cols-2 gap-6">
        <div className="grid gap-6">
          <div className="rounded-lg overflow-hidden">
            <Image src={pp} alt="XX59 gallery image 1" className="w-full h-full object-cover" />
          </div>
          <div className="rounded-lg overflow-hidden">
            <Image src={ppp} alt="XX59 gallery image 2" className="w-full h-full object-cover" />
          </div>
        </div>
        <div className="rounded-lg overflow-hidden">
          <Image src={pppp} alt="XX59 gallery image 3" className="w-full h-full object-cover" />
        </div>
      </section>
